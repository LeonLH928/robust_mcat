...
def get_custom_exp_code(args):
    ...
    ### Model Type
    if args.model_type == 'mcat' and args.generator:
      param_code += 'MCAT'+str(args.g_model_type).upper()
    elif args.model_type == 'mcat' and not args.generator:
      param_code += 'MCAT'
    elif args.model_type == 'survpath' and args.generator:
      param_code += 'SURVPATH'+str(args.g_model_type).upper()
    elif args.model_type == 'survpath' and not args.generator:
      param_code += 'SURVPATH'
